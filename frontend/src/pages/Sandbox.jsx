...
export default function Sandbox() {
  return (
    <div className="min-h-screen bg-[#1a0505] flex flex-col overflow-hidden">
      
      <div className="w-full z-50">
        <TopNavigation currentQuestion={7} />
      </div>

      <div className="flex-1 w-full relative flex flex-wrap items-center justify-center p-20 gap-20 overflow-y-auto">
