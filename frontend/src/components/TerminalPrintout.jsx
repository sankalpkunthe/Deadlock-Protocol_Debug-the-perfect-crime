...
export default function TerminalPrintout({ logDate, user, content, rotation = 0, scale = 1 }) {
    ...
    >
      ...
      <div className="flex-1 p-6 flex flex-col">
        ...
        <div className="text-center border-b-2 border-black/30 pb-3 mb-4">
          <p className="font-bold tracking-[0.2em] text-[20px]">*** EVIDENCE LOG ***</p>
          <p className="text-[16px] opacity-70 mt-1">TERMINAL 42-X</p>
        </div>

        <div className="text-[14px] space-y-1 uppercase mb-6 font-bold opacity-80">
        ...
        <div className="text-[14px] font-bold leading-relaxed whitespace-pre-wrap flex-1">
          {content}
        </div>

        <div className="mt-6 text-center text-[12px] opacity-50 uppercase tracking-widest">
          END OF TRANSMISSION
        </div>
      </div>
